...
export function TwentyThreeFour() {
...
transition={springTransition}
layoutId="options"
className="absolute w-full rounded-3xl bg-background h-full" ></motion.div>
                  ...
                  {options.map((op) => {
                    return (
                      ...
                      >
                        ...
                        `<span className="relative z-10">`{op}
                      </motion.div>
                    );
                  })}
                `</div>`
            ...
            >
              {days.map((d, index) => {
                return (
                  ...
                  >
                    `<span className="relative z-10">`{d}
                    {index === day && (
                      <motion.div
                        transition={springTransition}
                        layoutId="dayOptions"
...
export default TwentyThreeFour
