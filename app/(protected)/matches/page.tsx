        ...
        {matches && matches.length > 0 ? (
          matches.map((match) => (
            <Link 
              ...
              className="relative overflow-hidden bg-slate-900/30 backdrop-blur-2xl rounded-3xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.3)] border border-white/10 hover:bg-slate-800/40 hover:border-indigo-400/30 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] hover:-translate-y-1 transition-all duration-300 flex flex-col md:flex-row items-center justify-between gap-6 block group"
            >
              ...
              <div className="flex-1 text-center md:text-left relative z-10">
                <p className="text-sm text-indigo-300 font-bold mb-2 uppercase tracking-widest drop-shadow-md">
              ...
              <div className="relative z-10 bg-gradient-to-br from-indigo-500 to-purple-600 text-white px-8 py-4 rounded-2xl font-bold uppercase tracking-wide text-sm whitespace-nowrap shadow-[0_0_20px_rgba(99,102,241,0.4)] group-hover:shadow-[0_0_30px_rgba(168,85,247,0.6)] group-hover:scale-105 transition-all duration-300 border border-white/20">
                Scommetti Ora
              </div>
            </Link>
          ))
